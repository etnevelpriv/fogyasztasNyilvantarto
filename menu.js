...
import { readFuvarosok, readFuvarok, shortestDistance, largestConsumption } from './services/csvServices.js';
import { newFuvar } from './services/fuvarService.js';

export const displayMenu = async function () {
    console.log(`
Menü
        ...
        switch (Number(menuNum)) {
            ...
            case 5:
                if (!fuvarok) {
                    ...
                    console.log(largestConsumption(fuvarok));
                };
                break;
            default:
                console.log('Kilepes...');
